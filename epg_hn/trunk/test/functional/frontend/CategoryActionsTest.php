...
array(
        ...
        'format'  => 's',
        'method'  => 'p',
        'post'    => array('xmlString' => '<?xml version="1.0" encoding="utf-8"?><request website="http://iptv.cedock.com"><parameter type="GetMediaListByCategory" language="zh-CN"><device devmodel="hs16" dnum="1234" didtoken="x" ver="12.3.4" /><user huanid="1234" token="x" ver="2" /><data cid="1" order="1" page="1" size="10"><filter type="地区" value="美国" /><filter type="时间" value="lt1980" /></data></parameter></request>'),
        'timeout' => 2,
    ));
    echo $data;
