...
<?php include_partial("wiki/screenshots"); ?>
	  <div id="content">
        <div class="content_inner">
			...
			<!--
            <form method="POST" id="spForm" name="spForm" action="<?php echo url_for("sp/add");?>">
            -->
            <?php echo $form->renderFormTag(url_for("sp/add"),array('name'=>'spForm','id'=>'spForm')) ?>
              ...
              <div class="widget">
				...
				<div class="widget-body">
				  <ul class="wiki-meta">
					 ...
					 <li>
					 	<label>运营商图片:</label>
					 	<a id="file-uploads" class="button" href="<?php echo url_for('media/link'); ?>?function_name=spitemAdds">上传剧照</a>
					 </li>                     
					<ul id="right">
		            </ul> 
				  </ul>
