              ...
              <div class="widget">
				...
				<div class="widget-body">
		          ...
		          <li><span class='span_'>名称</span><input style='width:90%;float:right;padding-right:20px' type='text' name='name' value=''></li>
					    ...
					    <li><span class='span_'>频点Id</span><input  style='width:90%;float:right;padding-right:20px'   type='text' name='tsId' value=''></li>
					    ...
					    <li><span class='span_'>频道号</span><input id='mylogo_' style='width:90%;float:right;padding-right:20px'  type='text' name='channel_code' value=''></li>
		          <li style='cursor:pointer;color:orange;background:#ccc'>输入频道号获取台标！</li>
					    <li id='logo_'  style='cursor:pointer;color:orange;background:#ccc'></li>
		        </ul>
		        
<script>
function getTags(){
	var tags = ['cctv','tv','hd','pay','local'];
	var html = ''
