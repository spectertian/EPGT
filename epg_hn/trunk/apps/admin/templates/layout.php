...
<!--              <li><a href="index.php?option=com_config">站点设置</a></li>-->
          ...
          <li>
            ...
            <menu>
              ...
              <li <?php if( in_array("spservice",$action)):?> class="actived" <?php endif;?> ><a href="<?php echo url_for('@spservice')?>">运营商</a></li>
            </menu>
          </li>
          <li>
          ...
          <li>
            <div class="menu menu_content"><a href="#"><strong>内容导入</strong></a></div>
            <menu>
              <li <?php if( in_array("inject",$action) ):?>class="actived" <?php endif;?> ><a href="<?php echo url_for('content/inject')?>">内容导入</a></li>
              <li <?php if( in_array("import",$action) ):?>class="actived" <?php endif;?> ><a href="<?php echo url_for('content/import')?>">内容处理</a></li>
            </menu>
          </li>
        </nav>
      </aside>
...
jQuery(document).ready(function() {
	...
	$("nav").find("li").find('.actived').parent('menu').parent('li').addClass("actived");
});
