...
// date: 2013/05/23 11:20:04
  ...
  'cache_dir' => '/hwdata/www/hnepg/cache/henan_tv/prod/i18n',
  'lifetime' => 31556926,
  'prefix' => '/hwdata/www/hnepg/apps/henan_tv/i18n',
));
...
if ($parameters = $this->factories['routing']->parse($this->factories['request']->getPathInfo()))
{
  ...
  $class = sfConfig::get('sf_factory_storage', 'sfMongoSessionStorage');
  $this->factories['storage'] = new $class(array_merge(array(
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('5itv_sess'),
'database' => $this->getDatabaseManager()->getDatabase('mondongo'),
), sfConfig::get('sf_factory_storage_parameters', array (
  'session_name' => '5itv_sess',
  'db_table' => 'session',
))));
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/hwdata/www/hnepg/cache/henan_tv/prod/template',
  'lifetime' => 86400,
  'prefix' => '/hwdata/www/hnepg/apps/henan_tv/template',
)));
