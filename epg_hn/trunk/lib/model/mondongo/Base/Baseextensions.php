...
/**
 * Base class of extensions document.
 */
abstract class Baseextensions extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('extensions');
    }
    ...
    {
        return $this->getMondongo()->getRepository('extensions');
    }
