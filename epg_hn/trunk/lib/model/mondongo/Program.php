...
class Program extends \BaseProgram
{
    ...
    public function getChannel() {   
        if (! $this->channel) {
            ...
            $mondongo = $this->getMondongo();
            $this->channel = $mondongo->getRepository('SpService')->getServicesByChannelCode($channel_code);            
        }
...
//            $xapian_document->add_term('Z'.$word['word']);
    ...
    /**
     * 根据channelcode 从 spservice 取出 serviceId
