...
abstract class BaseDict extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['keyword'])) {
            $this->data['fields']['keyword'] = (string) $data['keyword'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        if (isset($fields['keyword'])) {
            $fields['keyword'] = (string) $fields['keyword'];
        }
    ...
    {
        if (!array_key_exists('keyword', $this->fieldsModified)) {
            $this->fieldsModified['keyword'] = $this->data['fields']['keyword'];
        } elseif ($value === $this->fieldsModified['keyword']) {
            unset($this->fieldsModified['keyword']);
        }

        $this->data['fields']['keyword'] = $value;
    }

    /**
     * Returns the "keyword" field.
     *
     * @return mixed The keyword field.
     */
    public function getKeyword()
    {
        return $this->data['fields']['keyword'];
    }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['keyword']) {
            $array['keyword'] = $this->data['fields']['keyword'];
        }
