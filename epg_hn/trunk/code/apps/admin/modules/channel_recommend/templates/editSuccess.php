          ...
          <li class="add"><a href="<?php echo url_for("channel_recommend/index")?>">推荐列表</a></li>
            ...
            <div class="table_nav">
				...
				<div class="widget-body">
				  <ul class="wiki-meta">
                     <li><label>所属频道：</label><?php include_partial('searcha',array( 'topTvStations'=>$parentTvStations,'channels'=>$channels,'channel_id'=>$channel_id,'tvStation_id'=>$tvStation_id ));?></li>
