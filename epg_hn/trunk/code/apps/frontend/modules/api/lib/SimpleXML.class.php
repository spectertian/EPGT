...
class Simple {
    ...
    private function setVideoUrl($tvn=0,$vod='',$title=''){
        //return "http://proxy.kkttww.net:8080/urlproxy/qiyi/?redirect=1&tv_id=".$id;
		return "http://10.63.64.71:8078/gateway/playServlet?businessInfoId=gqjbbvod&stbId=".$tvn."&resourceId=".$vod."&startTime=0&name=".$title."&bm=1";
    }
                            ...
                            if($whether_mark)
                            {
                            	 foreach ($videos as $video) {
    		                            ...
    		                            $nodeArray['data'][0]['media'][$i]['episodes'][0]['episode'][$j][DOM::ATTRIBUTES] = array(
    		                                ...
    		                                "rate" => 0,
    		                                "vip" => 0,
    		                                "url" => $this->setVideoUrl($tvconfig['tvn'],$vod='55555555',$title='555555'),
    		                                "live" => 0
    		                            );
                                        $j++;
                            	 }
                            ...
                            else
                            {
    	                        foreach ($videos as $video) {
    	                            ...
    	                            $nodeArray['data'][0]['media'][$i]['episodes'][0]['episode'][$j][DOM::ATTRIBUTES] = array(
    	                                ...
    	                                "rate" => 0,
    	                                "vip" => 0,
    	                                "url" => $this->setVideoUrl($tvconfig['tvn'],$tvconfig['videoId'],$video->getTitle()),
    	                                "live" => 0
    	                            );
    	                            $j++;
    	                        }
