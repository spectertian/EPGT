...
<div class="epg-list-new">
    <div class="channel-list">
        ...
        <script type="text/javascript">
            ...
            <?php if ($channel->getId() == $channel_id): ?>
            m.cops = <?php echo $k; ?>;
            <?php endif; ?>
            m.addNav("<?php echo $channel->getId(); ?>",<?php echo json_encode($channel->getName()); ?>);
            <?php endforeach; ?>
...
<div class="footer">
    <div class="help"><span>按</span> <span class="arrows_vertical">&lt; &gt;</span> <span>键滚动节目列表</span> <span>，按</span> <span class="button_menu">menu</span> <span>键返回上一级</span></div>
</div>

<script type="text/javascript">
var storeDatas = {
    date: '<?php echo date('Y-m-d');?>',
    channel_id: <?php echo $channel_id ? $channel_id : $channels[0]->getId() ?>
};
$(function(){
    $('#channel-slider').list({
        direction: 'H',
