...
/**
 * Base class of ContentTemp document.
 */
abstract class BaseContentTemp extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ContentTemp');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ContentTemp');
    }
