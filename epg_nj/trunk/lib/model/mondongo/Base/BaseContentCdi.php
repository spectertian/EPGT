...
/**
 * Base class of ContentCdi document.
 */
abstract class BaseContentCdi extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ContentCdi');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ContentCdi');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['command'])) {
            $this->data['fields']['command'] = (string) $data['command'];
        }
        if (isset($data['subcontent_id'])) {
            $this->data['fields']['subcontent_id'] = (string) $data['subcontent_id'];
        }
        if (isset($data['page_id'])) {
            $this->data['fields']['page_id'] = (string) $data['page_id'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['command'])) {
            $fields['command'] = (string) $fields['command'];
        }
        if (isset($fields['subcontent_id'])) {
            $fields['subcontent_id'] = (string) $fields['subcontent_id'];
        }
        if (isset($fields['page_id'])) {
            $fields['page_id'] = (string) $fields['page_id'];
        }
    ...
    {
        if (!array_key_exists('command', $this->fieldsModified)) {
            $this->fieldsModified['command'] = $this->data['fields']['command'];
        } elseif ($value === $this->fieldsModified['command']) {
            unset($this->fieldsModified['command']);
        }

        $this->data['fields']['command'] = $value;
    }

    /**
     * Returns the "command" field.
     *
     * @return mixed The command field.
     */
    public function getCommand()
    {
        return $this->data['fields']['command'];
    }

    /**
     * Set the "subcontent_id" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setSubcontentId($value)
    {
        if (!array_key_exists('subcontent_id', $this->fieldsModified)) {
            $this->fieldsModified['subcontent_id'] = $this->data['fields']['subcontent_id'];
        } elseif ($value === $this->fieldsModified['subcontent_id']) {
            unset($this->fieldsModified['subcontent_id']);
        }

        $this->data['fields']['subcontent_id'] = $value;
    }

    /**
     * Returns the "subcontent_id" field.
     *
     * @return mixed The subcontent_id field.
     */
    public function getSubcontentId()
    {
        return $this->data['fields']['subcontent_id'];
    }

    /**
     * Set the "page_id" field.
     *
     * @param mixed $value The value.
     *
     * @return void
    ...
    {
        if (!array_key_exists('page_id', $this->fieldsModified)) {
            $this->fieldsModified['page_id'] = $this->data['fields']['page_id'];
        } elseif ($value === $this->fieldsModified['page_id']) {
            unset($this->fieldsModified['page_id']);
        }

        $this->data['fields']['page_id'] = $value;
    }

    /**
     * Returns the "page_id" field.
     *
     * @return mixed The page_id field.
     */
    public function getPageId()
    {
        return $this->data['fields']['page_id'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['command'])) {
            $this->setCommand($array['command']);
        }
        if (isset($array['subcontent_id'])) {
            $this->setSubcontentId($array['subcontent_id']);
        }
        if (isset($array['page_id'])) {
            $this->setPageId($array['page_id']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['command']) {
            $array['command'] = $this->data['fields']['command'];
        }
        if (null !== $this->data['fields']['subcontent_id']) {
            $array['subcontent_id'] = $this->data['fields']['subcontent_id'];
        }
        if (null !== $this->data['fields']['page_id']) {
            $array['page_id'] = $this->data['fields']['page_id'];
        }
