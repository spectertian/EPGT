...
/**
 * Base class of OfflineLog document.
 */
abstract class BaseOfflineLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('OfflineLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('OfflineLog');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['user'])) {
            $this->data['fields']['user'] = (string) $data['user'];
        }
    ...
    {
        if (!array_key_exists('user', $this->fieldsModified)) {
            $this->fieldsModified['user'] = $this->data['fields']['user'];
        } elseif ($value === $this->fieldsModified['user']) {
            unset($this->fieldsModified['user']);
        }

        $this->data['fields']['user'] = $value;
    }

    /**
     * Returns the "user" field.
     *
     * @return mixed The user field.
     */
    public function getUser()
    {
        return $this->data['fields']['user'];
    }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['user']) {
            $array['user'] = $this->data['fields']['user'];
        }
