...
/**
 * Base class of ProgramWeek document.
 */
abstract class BaseProgramWeek extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ProgramWeek');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ProgramWeek');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['channel_type'])) {
            $this->data['fields']['channel_type'] = $data['channel_type'];
        }
        if (isset($data['tags'])) {
        ...
        if (isset($data['cpg_content_id'])) {
            $this->data['fields']['cpg_content_id'] = (string) $data['cpg_content_id'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['channel_type'])) {
            $fields['channel_type'] = $fields['channel_type'];
        }
        ...
        if (isset($fields['cpg_content_id'])) {
            $fields['cpg_content_id'] = (string) $fields['cpg_content_id'];
        }
    ...
    /**
     * Set the "cpg_content_id" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setCpgContentId($value)
    {
        if (!array_key_exists('cpg_content_id', $this->fieldsModified)) {
            $this->fieldsModified['cpg_content_id'] = $this->data['fields']['cpg_content_id'];
        } elseif ($value === $this->fieldsModified['cpg_content_id']) {
            unset($this->fieldsModified['cpg_content_id']);
        }

        $this->data['fields']['cpg_content_id'] = $value;
    }

    /**
     * Returns the "cpg_content_id" field.
     *
     * @return mixed The cpg_content_id field.
     */
    public function getCpgContentId()
    {
        return $this->data['fields']['cpg_content_id'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['cpg_content_id'])) {
            $this->setCpgContentId($array['cpg_content_id']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['cpg_content_id']) {
            $array['cpg_content_id'] = $this->data['fields']['cpg_content_id'];
        }
