...
/**
 * Base class of Words document.
 */
abstract class BaseWords extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('Words');
    }
    ...
    {
        return $this->getMondongo()->getRepository('Words');
    }
