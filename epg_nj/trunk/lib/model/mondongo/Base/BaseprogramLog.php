...
/**
 * Base class of programLog document.
 */
abstract class BaseprogramLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('programLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('programLog');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['nums'])) {
            $this->data['fields']['nums'] = (int) $data['nums'];
        }
        if (isset($data['wikinums'])) {
            $this->data['fields']['wikinums'] = (int) $data['wikinums'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['nums'])) {
            $fields['nums'] = (int) $fields['nums'];
        }
        if (isset($fields['wikinums'])) {
            $fields['wikinums'] = (int) $fields['wikinums'];
        }
     ...
     * @return void
     */
    public function setNums($value)
    {
        if (!array_key_exists('nums', $this->fieldsModified)) {
            $this->fieldsModified['nums'] = $this->data['fields']['nums'];
        } elseif ($value === $this->fieldsModified['nums']) {
            unset($this->fieldsModified['nums']);
        }

        $this->data['fields']['nums'] = $value;
    }

    /**
     * Returns the "nums" field.
     *
     * @return mixed The nums field.
     */
    public function getNums()
    {
        return $this->data['fields']['nums'];
    }

    /**
     * Set the "wikinums" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setWikinums($value)
    {
        if (!array_key_exists('wikinums', $this->fieldsModified)) {
            $this->fieldsModified['wikinums'] = $this->data['fields']['wikinums'];
        } elseif ($value === $this->fieldsModified['wikinums']) {
            unset($this->fieldsModified['wikinums']);
        }

        $this->data['fields']['wikinums'] = $value;
    }

    /**
     * Returns the "wikinums" field.
     *
     * @return mixed The wikinums field.
     */
    public function getWikinums()
    {
        return $this->data['fields']['wikinums'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['nums'])) {
            $this->setNums($array['nums']);
        }
        if (isset($array['wikinums'])) {
            $this->setWikinums($array['wikinums']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['nums']) {
            $array['nums'] = $this->data['fields']['nums'];
        }
        if (null !== $this->data['fields']['wikinums']) {
            $array['wikinums'] = $this->data['fields']['wikinums'];
        }
