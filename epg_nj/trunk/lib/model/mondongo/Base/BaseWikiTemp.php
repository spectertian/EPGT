...
/**
 * Base class of WikiTemp document.
 */
abstract class BaseWikiTemp extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('WikiTemp');
    }
