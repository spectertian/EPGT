...
/**
 * Base class of QueueLog document.
 */
abstract class BaseQueueLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('QueueLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('QueueLog');
    }
