...
abstract class BaseWiki extends \Mondongo\Document\Document implements \ArrayAccess
{
  ...
  1 => 'slugify',
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['video_update'])) {
            $date = new \DateTime(); $date->setTimestamp($data['video_update']->sec); $this->data['fields']['video_update'] = $date;
        }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['douban_id'])) {
            $fields['douban_id'] = (string) $fields['douban_id'];
        }
        if (isset($fields['verify'])) {
            $fields['verify'] = (int) $fields['verify'];
        }
        if (isset($fields['video_update'])) {
            if ($fields['video_update'] instanceof \DateTime) { $fields['video_update'] = $fields['video_update']->getTimestamp(); } elseif (is_string($fields['video_update'])) { $fields['video_update'] = strtotime($fields['video_update']); } $fields['video_update'] = new \MongoDate($fields['video_update']);
        }
    ...
    /**
     * Returns the "verify" field.
     *
     * @return mixed The verify field.
     */
    ...
    /**
     * Set the "video_update" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setVideoUpdate($value)
    {
        if (!array_key_exists('video_update', $this->fieldsModified)) {
            $this->fieldsModified['video_update'] = $this->data['fields']['video_update'];
        } elseif ($value === $this->fieldsModified['video_update']) {
            unset($this->fieldsModified['video_update']);
        }

        $this->data['fields']['video_update'] = $value;
    }

    /**
     * Returns the "video_update" field.
     *
     * @return mixed The video_update field.
     */
    public function getVideoUpdate()
    {
        return $this->data['fields']['video_update'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['video_update'])) {
            $this->setVideoUpdate($array['video_update']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['video_update']) {
            $array['video_update'] = $this->data['fields']['video_update'];
        }
