...
/**
 * Base class of VodhitLog document.
 */
abstract class BaseVodhitLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('VodhitLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('VodhitLog');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['hits'])) {
            $this->data['fields']['hits'] = (int) $data['hits'];
        }
        if (isset($data['date'])) {
    ...
    {
        if (!array_key_exists('hits', $this->fieldsModified)) {
            $this->fieldsModified['hits'] = $this->data['fields']['hits'];
        } elseif ($value === $this->fieldsModified['hits']) {
            unset($this->fieldsModified['hits']);
        }

        $this->data['fields']['hits'] = $value;
    }

    /**
     * Returns the "hits" field.
     *
     * @return mixed The hits field.
     */
    public function getHits()
    {
        return $this->data['fields']['hits'];
    }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['hits']) {
            $array['hits'] = $this->data['fields']['hits'];
        }
