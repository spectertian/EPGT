...
/**
 * Base class of LiveLog document.
 */
abstract class BaseLiveLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('LiveLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('LiveLog');
    }
