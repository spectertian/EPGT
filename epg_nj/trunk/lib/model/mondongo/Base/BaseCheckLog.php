...
/**
 * Base class of CheckLog document.
 */
abstract class BaseCheckLog extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('CheckLog');
    }
    ...
    {
        return $this->getMondongo()->getRepository('CheckLog');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['log'])) {
            $this->data['fields']['log'] = (string) $data['log'];
        }
        if (isset($data['time'])) {
    ...
    {
        if (!array_key_exists('log', $this->fieldsModified)) {
            $this->fieldsModified['log'] = $this->data['fields']['log'];
        } elseif ($value === $this->fieldsModified['log']) {
            unset($this->fieldsModified['log']);
        }

        $this->data['fields']['log'] = $value;
    }

    /**
     * Returns the "log" field.
     *
     * @return mixed The log field.
     */
    public function getLog()
    {
        return $this->data['fields']['log'];
    }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['log']) {
            $array['log'] = $this->data['fields']['log'];
        }
