 ...
 *  @author: lifucang
 */
class tmpEpgAdiTask extends sfMondongoTask
{
...
The [tmp:EpgAdi|INFO] task does things.
Call it with:

[php symfony tmp:EpgAdi|INFO]
EOF;
         //symfony tmp:EpgAdi --date=2012-12-01 --channel=GuiZhouTV --nosend=true  //nosend=true时不发送
         //symfony tmp:EpgAdi --tomorrow=1 //发送明天的数据
    }
