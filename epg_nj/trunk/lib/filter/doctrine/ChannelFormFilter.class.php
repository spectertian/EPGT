...
class ChannelFormFilter extends BaseChannelFormFilter
{
  public function configure()
  {
      ...
      $this->widgetSchema['type'] = new sfWidgetFormChoice(array('choices' => array(''=>'全部','cctv'=>'央视','tv'=>'卫视','local'=>'本地')));
      ...
      $this->validatorSchema['type'] = new sfValidatorChoice(array('required' => false,'choices'=>array(''=>'全部','cctv'=>'央视','tv'=>'卫视','local'=>'本地')));
  }
