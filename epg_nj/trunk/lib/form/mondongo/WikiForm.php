...
class WikiForm extends BaseWikiForm {
    ...
    public function configure() {
        unset($this['slug'],$this['source'], $this['rev'], $this['tvsou_id'], $this['wiki_id'], $this['html_cache'], $this['model'], $this['wiki_id'],$this['first_letter'],$this['douban_id'],$this['verify'],$this['video_update']);
