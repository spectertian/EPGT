...
/**
 * ProgramIndex form base class.
 *
 * @method ProgramIndex getObject() Returns the current form's model object
 *
 * @package    epg2.0
 * @subpackage form
 * @author     Huan Tek
 ...
 */
abstract class BaseProgramIndexForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('program_index[%s]');
