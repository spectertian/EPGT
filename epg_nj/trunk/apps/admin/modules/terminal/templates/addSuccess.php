...
<?php include_partial("wiki/screenshots"); ?>
	  <div id="content">
        <div class="content_inner">
			...
			<!--
            <form method="POST" id="spForm" name="spForm" action="<?php echo url_for("terminal/add");?>">
            -->
            <?php echo $form->renderFormTag(url_for("terminal/add"),array('name'=>'terminalForm','id'=>'terminalForm')) ?>
