				...
				<div class="widget-body">
				  <ul class="wiki-meta">
				      <li><span class='span_'>&nbsp;</span><input Disabled style='background:#eee;width:50%;float:left;padding-right:20px'  type='text' name='createdAt' value='<?php echo '创建时间:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$createdAt; ?>'></li>
                        ...
                        <li><span class='span_'>serviceId</span><input style='width:90%;float:right;padding-right:20px'  type='text' name='serviceId' value='<?php echo $serviceId; ?>'></li>
                        ...
                        <li><span class='span_'>抓取code</span><input id='mylogoa_' style='width:90%;float:right;padding-right:20px'  type='text' name='channel_codea' value='<?php echo $channel_codea; ?>'></li>
                        <li><span class='span_'>频道logo</span><input id='mylogo' style='width:90%;float:right;padding-right:20px'  type='text' name='channel_logo' value='<?php echo $channel_logo; ?>'></li>
                        <li><span class='span_'>频道ID</span><input id='channelID' style='width:90%;float:right;padding-right:20px'  type='text' name='channel_id' value='<?php echo $channel_id; ?>'></li>
					    <li><span class='span_'>频道编码</span><input id='channelNum' style='width:90%;float:right;padding-right:20px'  type='text' name='channel_num' value='<?php echo $channel_num; ?>'></li>
