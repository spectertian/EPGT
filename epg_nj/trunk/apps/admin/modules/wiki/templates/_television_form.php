                ...
                <div class="widget-body">
                  <ul class="vod">
                    ...
                    <?php foreach ($PlayList as $playlist):?> 
		                    <li>
		                        <a href="/video/show/id/<?php echo $playlist->getWikiId();?>" target="_blank"><?php echo $playlist->getRefererZhcn()?>查看视频</a>
                ...
                <div class="widget-body" style="width: 100%;">
                  <ul class="vod" style="width: 100%;">
                    ...
                    <?php foreach ($VideoList as $videolist):?> 
		                    <li style="width: 100%;">
		                        <a href="<?php echo $videolist->getUrl()?>" target="_blank"><?php echo $videolist->getTitle()?></a>
