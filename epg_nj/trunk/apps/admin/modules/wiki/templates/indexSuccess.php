...
<!--          <form action="" method="get">-->
            ...
            <?php $path="c=$c&q=$q&m=$m&video=$video&tag=$tag";?>
            <div class="table_nav">
                <?php include_partial('search', array('c' => $c,'q' => $q,'m' => $m,'video' => $video,'users'=>$users,'tag'=>$tag))?>
            <div class="paginator">
              <span class="first-page">
                  <a href="<?php echo url_for("wiki/index?$path&page=".$wiki->getFirstPage());?>">
                  最前页
                  </a>
              </span>
              <span class="prev-page">
                 <a href="<?php echo url_for("wiki/index?$path&page=".$wiki->getPreviousPage());?>">上一页</a>
              </span>
              <span class="pages">
                ...
                <?php foreach ($links as $key => $value):?>
                    ...
                    <?php else:?>
                        <a href="<?php echo url_for("wiki/index?$path&page=".$value );?>"><?php echo $value;?></a>
                    <?php endif;?>
                <?php endforeach;?>
              </span>
              <span class="next-page"><a href="<?php echo url_for("wiki/index?$path&page=".$wiki->getNextPage());?>">下一页</a></span>
              <span class="last-page"><a href="<?php echo url_for("wiki/index?$path&page=".$wiki->getLastPage());?>">最末页</a></span>
