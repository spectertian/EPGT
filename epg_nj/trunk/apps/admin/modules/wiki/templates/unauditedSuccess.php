...
<!--          <form action="" method="get">-->
            <header>
              <h2 class="content">未审核维基列表</h2>
              <nav class="utility">
                <li class="recommended"><a href="javascript:submitform('verify');">审核通过</a></li>
              </nav>
            </header>
            ...
            <div class="paginator">
              <span class="first-page">
                  <a href="<?php echo url_for("wiki/unaudited?page=".$wiki->getFirstPage());?>">
                  最前页
                  </a>
              </span>
              <span class="prev-page">
                 <a href="<?php echo url_for("wiki/unaudited?page=".$wiki->getPreviousPage());?>">上一页</a>
              </span>
              <span class="pages">
                ...
                <?php foreach ($links as $key => $value):?>
                    ...
                    <?php else:?>
                        <a href="<?php echo url_for("wiki/unaudited?page=".$value );?>"><?php echo $value;?></a>
                    <?php endif;?>
                <?php endforeach;?>
              </span>
              <span class="next-page"><a href="<?php echo url_for("wiki/unaudited?page=".$wiki->getNextPage());?>">下一页</a></span>
              <span class="last-page"><a href="<?php echo url_for("wiki/unaudited?page=".$wiki->getLastPage());?>">最末页</a></span>
            ...
            <table cellspacing="0">
              ...
              <?php if(isset ($wiki)):?>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo url_for("wiki/verify?id=".$rs->getId())?>">审核</a></td>
                </tr>
                <?php endforeach;?>
              <?php endif;?>
              </tbody>
