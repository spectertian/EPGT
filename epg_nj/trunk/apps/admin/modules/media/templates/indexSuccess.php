      ...
      <div id="content">
        <div class="content_inner">
            <header>
              ...
              <nav class="utility">
                <li class="app-add"><a class="toolbar" href="http://172.31.200.121:8082/list/all" title="当天图片查看" target="_blank">当天图片</a></li>
                <li class="delete">
              ...
              <div class="inner">
                ...
                <div id="file-content">
                  ...
                  <form action="<?php echo url_for('attachments_collection', array('action' => 'batch')) ?>" name="adminForm" id="adminForm" method="post">
                      ...
                      <div id="media_list"><?php include_component("media", "list",array('category_id'=>$category_id,'page'=>$page,'popup'=>$popup,'source_name'=>$source_name,'wiki_title'=>$wiki_title,'wiki'=>$wiki)) ?></div>
                   </form>
                    </div>
                    <br>
