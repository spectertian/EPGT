...
<html>
 ...
 <body>
	...
	<?php else :?>
		<a href="/list/allTemp/page/<?php echo $i;?>/date/<?php echo $date;?>"><?php echo $i;?></a>
	<?php endif;?>
	<?php endfor;?>
		</span>
	</div>
	...
	<?php foreach ($wikisArr as $data) :?>
		<li>
			<a href="http://image.epg.huan.tv/1/1/1/<?php echo $data['cover'];?>" target="_blank"><img alt="" src="<?php echo thumb_url($data['cover'], 105, 140,'122.193.13.36')?>"></a>
