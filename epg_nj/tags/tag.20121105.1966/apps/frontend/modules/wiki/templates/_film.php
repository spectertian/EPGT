<div class="tooltip-hd">
      <h3>
          ...
          <?php if($wiki->getReleased() || $wiki->getRuntime()) :?>
          <small>(<span class="release-date"><?php echo $wiki->getReleased()?></span> <span class="episode-nmb"><?php echo $wiki->getRuntime()?>分钟</span>)</small>
          <?php endif;?>
      </h3>
    </div>
