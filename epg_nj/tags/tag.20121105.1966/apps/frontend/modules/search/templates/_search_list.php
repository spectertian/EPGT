          ...
          <?php if ($wiki_pager->count() > 0):?>
            ...
            <?php foreach ($wiki_pager as $wiki): ?>
              <li>
                <div class="program">
                  <div class="poster"><a href="<?php echo url_for("wiki/show?slug=".$wiki->getSlug())?>"><img src="<?php echo thumb_url($wiki->getCover(), 100, 150)?>" width="100" height="150" alt="<?php echo $wiki->getTitle()?>"></a></div>
