...
/**
 * Base class of SingleChip document.
 */
abstract class BaseSingleChip extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('SingleChip');
    }
    ...
    {
        return $this->getMondongo()->getRepository('SingleChip');
    }
