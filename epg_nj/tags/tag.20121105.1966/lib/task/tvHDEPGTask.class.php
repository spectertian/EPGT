...
class tvHDEPGTask extends sfMondongoTask
{
...
The [tv:HDEPG|INFO] task does things.
Call it with:

  [php symfony tv:HDEPG|INFO]
EOF;
  }
    ...
    protected function execute($arguments = array(), $options = array())
    {
        ...
        foreach($channels as $channel){
               $nodeArray=array(); 
               $file='log/HD'.iconv("UTF-8","GBK",$channel->getName()).'.xml';
              ...
              $channelXML = DOM::arrayToXMLString($nodeArray,'BroadcastData',array('code'=>$channel->getCode(),'creationtime'=>date("YmsHis"),'version'=>'2.0'));
