...
/**
 * ThemeItem filter form base class.
 *
 * @package    epg2.0
 * @subpackage filter
 * @author     Huan Tek
 ...
 */
abstract class BaseThemeItemFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('theme_item_filters[%s]');
