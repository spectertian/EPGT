...
class Program extends \BaseProgram
{
     ...
     * 获取关联的sp频道
     * @return <obj>
     * @author lifucang 2012-12-11
     */
    public function getSpService() {   
        $channel_code = $this->getChannelCode();
        $mondongo = $this->getMondongo();
        $sp = $mondongo->getRepository('SpService')->getServicesByChannelCode($channel_code);            
        return $sp;
    }
    /**
     * 获取sp名称
    ...
    public function getSpName() {
        $sp = $this->getSpService();
        $channel_name = '';
        if($sp) {
            $channel_name = $sp->getName();
        }
        return $channel_name;
    } 
    /**
     ...
     * @author lfc
     */
    public function getSpLogo() {
        $sp = $this->getSpService();
        $logo = '';
        if($sp) {
            $logo = $sp->getChannelLogo();
        }
        return $logo;
    }
    /**
