...
/**
 * Base class of ContentImport1 document.
 */
abstract class BaseContentImport1 extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ContentImport1');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ContentImport1');
    }
