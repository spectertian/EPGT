...
/**
 * Base class of Terminal document.
 */
abstract class BaseTerminal extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('Terminal');
    }
    ...
    {
        return $this->getMondongo()->getRepository('Terminal');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['brand'])) {
            $this->data['fields']['brand'] = (string) $data['brand'];
        }
        if (isset($data['clienttype'])) {
            $this->data['fields']['clienttype'] = (string) $data['clienttype'];
        }
        if (isset($data['version'])) {
            $this->data['fields']['version'] = $data['version'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        if (isset($fields['brand'])) {
            $fields['brand'] = (string) $fields['brand'];
        }
        if (isset($fields['clienttype'])) {
            $fields['clienttype'] = (string) $fields['clienttype'];
        }
    ...
    {
        if (!array_key_exists('brand', $this->fieldsModified)) {
            $this->fieldsModified['brand'] = $this->data['fields']['brand'];
        } elseif ($value === $this->fieldsModified['brand']) {
            unset($this->fieldsModified['brand']);
        }

        $this->data['fields']['brand'] = $value;
    }

    /**
     * Returns the "brand" field.
     *
     * @return mixed The brand field.
     */
    public function getBrand()
    {
        return $this->data['fields']['brand'];
    }

    /**
     * Set the "clienttype" field.
     *
     * @param mixed $value The value.
     *
     * @return void
    ...
    {
        if (!array_key_exists('clienttype', $this->fieldsModified)) {
            $this->fieldsModified['clienttype'] = $this->data['fields']['clienttype'];
        } elseif ($value === $this->fieldsModified['clienttype']) {
            unset($this->fieldsModified['clienttype']);
        }

        $this->data['fields']['clienttype'] = $value;
    }

    /**
     * Returns the "clienttype" field.
     *
     * @return mixed The clienttype field.
     */
    public function getClienttype()
    {
        return $this->data['fields']['clienttype'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['clienttype'])) {
            $this->setClienttype($array['clienttype']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['brand']) {
            $array['brand'] = $this->data['fields']['brand'];
        }
        if (null !== $this->data['fields']['clienttype']) {
            $array['clienttype'] = $this->data['fields']['clienttype'];
        }
