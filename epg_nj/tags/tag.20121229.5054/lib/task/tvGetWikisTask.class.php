...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
        ...
        $json_posts=array();
        $json_posts[0]='{"action":"GetWikisDayGd","device":{"dnum":"123"},"user":{"userid":"123"},"param":{"start_time":"'.$startTime.'","end_time":"'.$endTime.'","queryat":"updated_at"}}';        
        $json_posts[1]='{"action":"GetWikisDayGd","device":{"dnum":"123"},"user":{"userid":"123"},"param":{"start_time":"'.$startTime.'","end_time":"'.$endTime.'"}}';
