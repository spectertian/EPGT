            ...
            <table cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <a href="<?php echo url_for('program/epg?channel_code='.$channel['code']) ?>" class="recommend" target="_blank">查看更新</a> | 
                  <a href="<?php echo url_for('program/epgOk?channel_code='.$channel['code']) ?>" class="recommend">编辑确认</a> | 
                  <a href="<?php echo url_for('program/epgGet?channel_code='.$channel['code']) ?>" class="recommend">重新抓取</a> | 
                  <a href="<?php echo url_for('program/index?channel_id='.$channel['id'].'&channel_code='.$channel['code'].'&date='.date('Y-m-d')) ?>" class="recommend">返回节目表</a>
                  </td>
                </tr>
                <?php endforeach;?>
              </tbody>
...
<script type="text/javascript">
    ...
    function reload()
    {
       location.href='<?php echo url_for("program/epgUpdate") ?>';
