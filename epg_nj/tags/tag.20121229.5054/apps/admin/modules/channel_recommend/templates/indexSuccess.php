...
<?php include_partial("wiki/screenshots"); ?>
    <div id="content">
        <div class="content_inner">
            <?php include_partial('toolbarList',array('channel_id'=>$channel_id))?>
                ...
                <table cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php if($recommend->getPic()):?><img src="<?php echo file_url($recommend->getPic())?>" width="120px;"><br><?php endif;?><a href="<?php echo url_for("channel_recommend/edit?id=".$recommend->getId())?>"><?php echo $recommend->getTitle()?></a></td>
                      ...
                      <td><a href="<?php echo url_for("channel_recommend/edit?channel_id=$channel_id&id=".$recommend->getId())?>" class="recommend">编辑</a> | <a href="<?php echo url_for("channel_recommend/delete?channel_id=$channel_id&id=".$recommend->getId())?>" onclick="if(!confirm('确定删除吗？')) return false;">删除</a></td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>    
