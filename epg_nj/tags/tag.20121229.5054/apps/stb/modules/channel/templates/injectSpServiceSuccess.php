...
<body>
    <div id="content"> 
      ...
      <span>
          ...
          <form target="_blank" action='/channel/InjectSpService' method="POST">
					<table cellspacing="0" cellpadding="4" frame="box" bordercolor="#dcdcdc" rules="none" style="border-collapse: collapse;">
                        ...
                        <tr>
                            ...
                            <textarea name="json_str" cols="100" rows="10" id="json_str"></textarea>
                            </td>
                        </tr>                        
                        <tr>
                          <td></td>
          ...
          <span>
			  ...
			  <?php echo '<pre>' . htmlspecialchars($client->request, ENT_QUOTES) . '</pre>'; ?>        
			  <?php echo '<pre>' . htmlspecialchars($client->response, ENT_QUOTES) . '</pre>'; ?>  
          </span>  
      </span>
	</div>
</body>
