...
<script type="text/javascript">
    ...
    function postSearch() {
        if(formsearch.q.value == '') {
            ...
            this.location = 'http://172.31.139.19/was5/web/search?searchword=' + formsearch.q.value + '&channelid=256823&BackUrl='+window.location.href;
        }
    }
    
    function goSearch(tag) {
        this.location = 'http://172.31.139.19/was5/web/search?searchword=' + tag + '&channelid=256823&BackUrl='+window.location.href;
    }
