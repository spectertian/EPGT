				...
				<div class="playlibrary">
					...
					<div class="itemnum" id="myvideo">
						<div class="hidenum">
                           ...
                           ?>
									<li class="videohs <?php echo ceil($j/10); ?>" id="<?php echo $j; ?>" value="<?php echo ceil($j/30); ?>"><a href="#"  onclick="playvideo('<?php echo $asset_id;?>','<?php echo $video->getReferer()?>');"><?php echo $video->getMark()?$video->getMark():$j;?></a></li>
                            <?php
                                	  $j++;
                                	  endforeach;
                                  endif;
