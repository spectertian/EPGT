...
array(
        ...
        'format'  => 's',
        'method'  => 'p',
        'post'    => array('xmlString' => '<?xml version="1.0" encoding="utf-8"?><request website="http://iptv.cedock.com"><parameter type="GetFilterOption" language="zh-CN"><device devmodel="hs16" dnum="1234" didtoken="x" ver="12.3.4" /><user huanid="1234" token="x" ver="2" /></parameter></request>'),
        'timeout' => 2,
    ));
    echo $data;
