...
/**
 * Base class of Developer document.
 */
abstract class BaseDeveloper extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('Developer');
    }
    ...
    {
        return $this->getMondongo()->getRepository('Developer');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['apikey'])) {
            $this->data['fields']['apikey'] = (string) $data['apikey'];
        }
        if (isset($data['secretkey'])) {
            $this->data['fields']['secretkey'] = (string) $data['secretkey'];
        }
        if (isset($data['state'])) {
            $this->data['fields']['state'] = (int) $data['state'];
        }
        if (isset($data['sources'])) {
            $this->data['fields']['sources'] = $data['sources'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['apikey'])) {
            $fields['apikey'] = (string) $fields['apikey'];
        }
        if (isset($fields['secretkey'])) {
            $fields['secretkey'] = (string) $fields['secretkey'];
        }
    ...
    {
        if (!array_key_exists('apikey', $this->fieldsModified)) {
            $this->fieldsModified['apikey'] = $this->data['fields']['apikey'];
        } elseif ($value === $this->fieldsModified['apikey']) {
            unset($this->fieldsModified['apikey']);
        }

        $this->data['fields']['apikey'] = $value;
    }

    /**
     * Returns the "apikey" field.
     *
     * @return mixed The apikey field.
     */
    public function getApikey()
    {
        return $this->data['fields']['apikey'];
    }
    ...
    {
        if (!array_key_exists('secretkey', $this->fieldsModified)) {
            $this->fieldsModified['secretkey'] = $this->data['fields']['secretkey'];
        } elseif ($value === $this->fieldsModified['secretkey']) {
            unset($this->fieldsModified['secretkey']);
        }

        $this->data['fields']['secretkey'] = $value;
    }

    /**
     * Returns the "secretkey" field.
     *
     * @return mixed The secretkey field.
     */
    public function getSecretkey()
    {
        return $this->data['fields']['secretkey'];
    }
    ...
    {
        if (!array_key_exists('sources', $this->fieldsModified)) {
            $this->fieldsModified['sources'] = $this->data['fields']['sources'];
        } elseif ($value === $this->fieldsModified['sources']) {
            unset($this->fieldsModified['sources']);
        }

        $this->data['fields']['sources'] = $value;
    }

    /**
     * Returns the "sources" field.
     *
     * @return mixed The sources field.
     */
    public function getSources()
    {
        return $this->data['fields']['sources'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['apikey'])) {
            $this->setApikey($array['apikey']);
        }
        if (isset($array['secretkey'])) {
            $this->setSecretkey($array['secretkey']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['apikey']) {
            $array['apikey'] = $this->data['fields']['apikey'];
        }
        if (null !== $this->data['fields']['secretkey']) {
            $array['secretkey'] = $this->data['fields']['secretkey'];
        }
        if (null !== $this->data['fields']['state']) {
            $array['state'] = $this->data['fields']['state'];
        }
        if (null !== $this->data['fields']['sources']) {
            $array['sources'] = $this->data['fields']['sources'];
        }
