...
/**
 * Base class of SimpleAdvert document.
 */
abstract class BaseSimpleAdvert extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('SimpleAdvert');
    }
    ...
    {
        return $this->getMondongo()->getRepository('SimpleAdvert');
    }
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['image'])) {
            $fields['image'] = (string) $fields['image'];
        }
        if (isset($fields['url'])) {
    ...
    {
        if (!array_key_exists('image', $this->fieldsModified)) {
            $this->fieldsModified['image'] = $this->data['fields']['image'];
        } elseif ($value === $this->fieldsModified['image']) {
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['image']) {
            $array['image'] = $this->data['fields']['image'];
        }
