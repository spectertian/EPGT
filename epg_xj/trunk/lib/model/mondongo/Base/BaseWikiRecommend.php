...
/**
 * Base class of WikiRecommend document.
 */
abstract class BaseWikiRecommend extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('WikiRecommend');
    }
    ...
    {
        return $this->getMondongo()->getRepository('WikiRecommend');
    }
