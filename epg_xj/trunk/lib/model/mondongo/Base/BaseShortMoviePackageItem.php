...
/**
 * Base class of ShortMoviePackageItem document.
 */
abstract class BaseShortMoviePackageItem extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ShortMoviePackageItem');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ShortMoviePackageItem');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['package_id'])) {
            $this->data['fields']['package_id'] = (string) $data['package_id'];
        }
        if (isset($data['short_movie_id'])) {
            $this->data['fields']['short_movie_id'] = (string) $data['short_movie_id'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        if (isset($fields['package_id'])) {
            $fields['package_id'] = (string) $fields['package_id'];
        }
        if (isset($fields['short_movie_id'])) {
            $fields['short_movie_id'] = (string) $fields['short_movie_id'];
        }
    ...
    {
        if (!array_key_exists('package_id', $this->fieldsModified)) {
            $this->fieldsModified['package_id'] = $this->data['fields']['package_id'];
        } elseif ($value === $this->fieldsModified['package_id']) {
            unset($this->fieldsModified['package_id']);
        }

        $this->data['fields']['package_id'] = $value;
    }

    /**
     * Returns the "package_id" field.
     *
     * @return mixed The package_id field.
     */
    public function getPackageId()
    {
        return $this->data['fields']['package_id'];
    }

    /**
     * Set the "short_movie_id" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setShortMovieId($value)
    {
        if (!array_key_exists('short_movie_id', $this->fieldsModified)) {
            $this->fieldsModified['short_movie_id'] = $this->data['fields']['short_movie_id'];
        } elseif ($value === $this->fieldsModified['short_movie_id']) {
            unset($this->fieldsModified['short_movie_id']);
        }

        $this->data['fields']['short_movie_id'] = $value;
    }

    /**
     * Returns the "short_movie_id" field.
     *
     * @return mixed The short_movie_id field.
     */
    public function getShortMovieId()
    {
        return $this->data['fields']['short_movie_id'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['short_movie_id'])) {
            $this->setShortMovieId($array['short_movie_id']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['package_id']) {
            $array['package_id'] = $this->data['fields']['package_id'];
        }
        if (null !== $this->data['fields']['short_movie_id']) {
            $array['short_movie_id'] = $this->data['fields']['short_movie_id'];
        }
