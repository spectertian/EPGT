...
/**
 * Base class of Setting document.
 */
abstract class BaseSetting extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('Setting');
    }
    ...
    {
        return $this->getMondongo()->getRepository('Setting');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['key'])) {
            $this->data['fields']['key'] = (string) $data['key'];
        }
        if (isset($data['value'])) {
    ...
    {
        if (!array_key_exists('key', $this->fieldsModified)) {
            $this->fieldsModified['key'] = $this->data['fields']['key'];
        } elseif ($value === $this->fieldsModified['key']) {
            unset($this->fieldsModified['key']);
        }
    ...
    {
        if (!array_key_exists('value', $this->fieldsModified)) {
            $this->fieldsModified['value'] = $this->data['fields']['value'];
        } elseif ($value === $this->fieldsModified['value']) {
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['key']) {
            $array['key'] = $this->data['fields']['key'];
        }
        if (null !== $this->data['fields']['value']) {
            $array['value'] = $this->data['fields']['value'];
        }
