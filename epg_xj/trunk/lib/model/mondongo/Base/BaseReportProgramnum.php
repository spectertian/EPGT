...
/**
 * Base class of ReportProgramnum document.
 */
abstract class BaseReportProgramnum extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ReportProgramnum');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ReportProgramnum');
    }
