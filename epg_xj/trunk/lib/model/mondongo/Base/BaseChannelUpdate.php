...
/**
 * Base class of ChannelUpdate document.
 */
abstract class BaseChannelUpdate extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ChannelUpdate');
    }
