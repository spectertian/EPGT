...
/**
 * Base class of NextweekProgram document.
 */
abstract class BaseNextweekProgram extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('NextweekProgram');
    }
    ...
    {
        return $this->getMondongo()->getRepository('NextweekProgram');
    }
