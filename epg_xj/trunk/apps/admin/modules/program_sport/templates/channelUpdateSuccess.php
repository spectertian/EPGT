            ...
            <table cellspacing="0">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td style="text-align: center;"><a href="<?php echo url_for('program_sport/tvsou?channel_code='.$channel['code']) ?>" class="recommend" target="_blank">点击查看更新</a> | <a href="<?php echo url_for('program/tvsouGet?channel_code='.$channel['code']) ?>" class="recommend">重新抓取</a> | <a href="<?php echo url_for('program/index?channel_id='.$channel['id'].'&date='.date('Y-m-d')) ?>" class="recommend">返回节目表</a></td>
                </tr>
                <?php endforeach;?>
              </tbody>
            </table>    
...
<script type="text/javascript">
    ...
    function reload()
    {
       location.href='<?php echo url_for("program_sport/channelUpdate") ?>';
