    ...
    <tr edit="0">
      ...
      <td class="sf_admin_text sf_admin_list_td_channel noEdit channel"  style="text-align:left;" >
        ...
        <td class="sf_admin_text sf_admin_list_td_actions noEdit actions edit" rel="<?php echo $program->getId();?>" style="text-align: center;">
            <?php if($program->getWikiId()):?><a target="_blank" href="<?php echo url_for("wiki/edit?id=".$program->getWikiId())?>">查看维基</a> | <?php endif;?><a href="#" onclick="changeTR($(this),'newProgram',false);return false;" >编辑</a> | <a href="#" onclick="if(confirm('确定删除吗？')){program_delete($(this),1);return false;}"  >删除</a>
        </td>
    </tr>
  <?php endforeach; ?>
<?php endif ?>
