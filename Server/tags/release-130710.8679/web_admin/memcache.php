...
define('ADMIN_PASSWORD','huantv');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

if($_SERVER['HTTP_HOST'] == "admin.epg.huan.tv"){
  $MEMCACHE_SERVERS[] = '192.168.8.221:11230'; // add more as an array
  $MEMCACHE_SERVERS[] = '192.168.8.67:11230'; // add more as an array
  $MEMCACHE_SERVERS[] = '192.168.8.68:11230'; // add more as an array
}
if($_SERVER['HTTP_HOST'] == "admin.5i.test.cedock.net"){
  $MEMCACHE_SERVERS[] = '118.194.161.68:11211'; // add more as an array
}
if($_SERVER['HTTP_HOST'] == "admin.5itest.tv"){
  $MEMCACHE_SERVERS[] = '192.168.10.71:11211';
}
...
h1.memcache span.logo span.name { color:white; font-size:0.9em; padding:0 0.8em 0 2em; }
...
<div class="head">
	<h1 class="memcache">
		<span class="logo"><a href="http://pecl.php.net/package/memcache">Memcache of Smart Epg</a></span>
