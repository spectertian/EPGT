...
/**
 * Base class of ContentInject document.
 */
abstract class BaseContentInject extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ContentInject');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ContentInject');
    }
