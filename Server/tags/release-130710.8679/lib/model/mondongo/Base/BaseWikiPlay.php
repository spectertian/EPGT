...
/**
 * Base class of WikiPlay document.
 */
abstract class BaseWikiPlay extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('WikiPlay');
    }
    ...
    {
        return $this->getMondongo()->getRepository('WikiPlay');
    }
