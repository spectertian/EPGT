...
/**
 * NextweekProgram Base Form.
 */
class BaseNextweekProgramForm extends BaseFormMondongo
{
    ...
    public function setup()
    {
        ...
        $this->widgetSchema->setNameFormat('nextweek_program[%s]');
    }
