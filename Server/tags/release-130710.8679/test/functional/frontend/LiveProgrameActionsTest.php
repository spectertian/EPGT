...
array(
        ...
        'format'  => 's',
        'method'  => 'p',
        'post'    => array('xmlString' => '<?xml version="1.0" encoding="utf-8"?><request website="http://iptv.cedock.com"><parameter type=" GetLivePrograme " language="zh-CN"><device devmodel="hs16" dnum="1234" didtoken="x" ver="12.3.4" /><user huanid="1234" token="x" ver="2" /><data province="四川" tag="电视剧" starttime="2011-11-7 08:00"endtime="2011-11-7 10:00" /></parameter></request>'),
        'timeout' => 2,
    ));
    echo $data;
