...
$postValue=<<<xml
<?xml version="1.0" encoding="utf-8"?><request website="http://iptv.cedock.com"><parameter type="GetRecommendByChannel " language="zh-CN"><device devmodel="hs16" dnum="1234" didtoken="x" ver="12.3.4" /><user huanid="1234" token="x" ver="2" /><data channelcode="123"/></parameter></request>
xml;
...
array(
        ...
        'format'  => 's',
        'method'  => 'p',
        'post'    => array('xmlString' => '<?xml version="1.0" encoding="utf-8"?><request website="http://iptv.cedock.com"><parameter type="GetRecommendByChannel " language="zh-CN"><device devmodel="hs16" dnum="1234" didtoken="x" ver="12.3.4" /><user huanid="1234" token="x" ver="2" /><data channelcode="123"/></parameter></request>'),
        'timeout' => 2,
    ));
    echo $data;
