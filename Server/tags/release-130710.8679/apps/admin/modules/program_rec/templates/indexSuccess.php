			    ...
			    <tr>
			        ...
			        <td>
			        	<?php if($program->getWikiId()):?>
							...
							<a class="add_ico" href="/program_rec/save?timeArea=<?php echo $timeArea ?>&id=<?php echo $program->getId();?>" >
            ...
            <table cellspacing="0" class="adminlist" id="admin_list_two">
              ...
              ?>
                <tr>
                  ...
                  <td><?php $starttime = $programRecs->getStartTime(); if($starttime) echo $programRecs->getStartTime()->format("H:i")?></td>
                  <td>
                  		<a href="/program_rec/delete?id=<?php echo $programRecs->getId();?>" >
