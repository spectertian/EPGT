...
function saves(arg) 
{
	...
	replace_stcok_data['play_url'] = 'undefinition';
...
<div id="content">
		...
		<?php if($isPager):?>
             <div class="paginator">
              <span class="first-page">
                  <a href="<?php echo url_for('nextweek_program/add?page='.$pager->getFirstPage().'&condition='.$condition.'&name='.$name.'&date='.$date);?>">
                  最前页
                  </a>
              </span>
              <span class="prev-page">
                 <a href="<?php echo url_for('nextweek_program/add?page='.$pager->getPreviousPage().'&condition='.$condition.'&name='.$name.'&date='.$date);?>">上一页</a>
              </span>
              <span class="pages">
                  <?php foreach ($pager->getLinks(5) as $page ):?>
                        ...
                        <?php else:?>
                            <a href="<?php echo url_for('nextweek_program/add?page='.$page.'&condition='.$condition.'&name='.$name.'&date='.$date);?>"><?php echo $page;?></a>
                        <?php endif;?>
                  <?php endforeach;?>
              </span>
              <span class="next-page"><a href="<?php echo url_for('nextweek_program/add?page='.$pager->getNextPage().'&condition='.$condition.'&name='.$name.'&date='.$date);?>">下一页</a></span>
              <span class="last-page"><a href="<?php echo url_for('nextweek_program/add?page='.$pager->getLastPage().'&condition='.$condition.'&name='.$name.'&date='.$date);?>">最末页</a></span>
		...
		<?php endif;?>
            ...
            <table cellspacing="0" class="yesterday_tables" id="yesterday_tables">
              <thead>
                <tr>
