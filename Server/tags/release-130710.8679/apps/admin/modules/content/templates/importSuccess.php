            ...
            <!--<a href='/content/import?deleted=1' style='margin-left:20px'><b style='color:red'>查看已删除</b></a>-->
                ...
                <div class="paginator">
                  <span class="first-page">
                      <a href="<?php echo url_for("content/import?page=".$imports->getFirstPage()."&searchwiki=".$wikistatus);?>">
                      最前页
                      </a>
                  </span>
                  <span class="prev-page">
                     <a href="<?php echo url_for("content/import?page=".$imports->getPreviousPage()."&searchwiki=".$wikistatus);?>">上一页</a>
                  </span>
                  <span class="pages">
                    ...
                    <?php foreach ($links as $key => $value):?>
                        ...
                        <?php else:?>
                            <a href="<?php echo url_for("content/import?page=".$value."&searchwiki=".$wikistatus );?>"><?php echo $value;?></a>
                        <?php endif;?>
                    <?php endforeach;?>
                  </span>
                  <span class="next-page"><a href="<?php echo url_for("content/import?page=".$imports->getNextPage()."&searchwiki=".$wikistatus);?>">下一页</a></span>
                  <span class="last-page"><a href="<?php echo url_for("content/import?page=".$imports->getLastPage()."&searchwiki=".$wikistatus);?>">最末页</a></span>
            ...
            <table cellspacing="0" id="admin_list" class="adminlist">
              ...
              <?php if(isset ($imports)):?>
                ...
                <tr edit="0">
                  ...
                  <td class="noEdit"><?php echo $types[$import->getFromType()];?></td>
