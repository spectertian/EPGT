	...
	if(action == 'save'){
		first_A.text(' 保存 ').attr({'href':'#'}).unbind('click').bind('click',function(){
                        ...
                        */                      
                        ...
                        //提交至服务端处理                        
                        $.post('<?php echo url_for('content/tempSave') ?>',program, function(data,textStatus){
...
function program_deleteajax(ids){
    $.ajax({
        url: '<?php echo url_for('content/tempDelete')?>',
        type: 'post',
        dataType: 'text',
        data: {'ids': ids},
        success: function(data){
            //alert(data);
            location.href='<?php echo url_for('content/temp')?>'; 
        }
    });
...
function program_delete(element,method){
        ...
        admin_form.action = "<?php echo url_for('content/tempDelete') ?>";
        admin_form.submit(); 
}
    ...
    admin_form.submit();
      ...
      <div id="content">
        <div class="content_inner">            
            ...
            <div class="table_nav">
            <form action='/content/temp' method='post'>
              WIKI:
              ...
              <a href="/content/temp">重置返回列表</a>
            </form>
                <div class="paginator">
                  <span class="first-page">
                      <a href="<?php echo url_for("content/temp?page=".$imports->getFirstPage());?>">
                      最前页
                      </a>
                  </span>
                  <span class="prev-page">
                     <a href="<?php echo url_for("content/temp?page=".$imports->getPreviousPage());?>">上一页</a>
                  </span>
                  <span class="pages">
                    ...
                    <?php foreach ($links as $key => $value):?>
                        ...
                        <?php else:?>
                            <a href="<?php echo url_for("content/temp?page=".$value );?>"><?php echo $value;?></a>
                        <?php endif;?>
                    <?php endforeach;?>
                  </span>
                  <span class="next-page"><a href="<?php echo url_for("content/temp?page=".$imports->getNextPage());?>">下一页</a></span>
                  <span class="last-page"><a href="<?php echo url_for("content/temp?page=".$imports->getLastPage());?>">最末页</a></span>
