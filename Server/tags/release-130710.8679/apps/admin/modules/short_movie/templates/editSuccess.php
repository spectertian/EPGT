	...
	$('#adForm').submit();return;
	  ...
	  <div id="content">
        <div class="content_inner">
			<header>
				<h2 class="content">编辑短视频</h2>
				<nav class="utility">
				  <li class="save"><a href="#" onclick="adddate();">保存</a></li>
				  <li class="back"><a href="<?php echo url_for("short_movie/index")?>">返回列表</a></li>
				</nav>
			</header>
			<?php include_partial('global/flashes')?>
			
            <form method="POST" id="adForm" name="adForm" action="/short_movie/edit">
              ...
              <div class="widget">
				...
				<div class="widget-body">
				  <ul class="wiki-meta">
					 ...
					 <li><label>url：</label><input type='text' name='url' value='<?php echo $sm->getUrl(); ?>'></li>
					 ...
					 <li><label>作者：</label><input type='text' name='author' value='<?php echo $sm->getAuthor(); ?>'></li>
					 <li><label>来源：</label><input type='text' name='refer' value='<?php echo $sm->getRefer(); ?>'></li>
					 <li>
					   <label>状态：</label>
					   <select name='state'>
					 ...
					 <li>
                        ...
                        <?php if($sm->getCover()):?>    
								<!--<input id="theme_img" name="theme[img]" value="<?php echo $sm->getCover();?>" type="hidden" />-->			
					 	...
					 	<?php if($sm->getCover()):?>
					 	<a id="file-uploads" class="button" href="<?php echo url_for('media/link'); ?>?function_name=smscreenshotAdds">更改剧照</a>
					 	<?php else:?>
					 	<a id="file-uploads" class="button" href="<?php echo url_for('media/link'); ?>?function_name=smscreenshotAdds">上传剧照</a>
					 	<?php endif;?>
		                </ul> 
					 </li>                     
				  </ul>
