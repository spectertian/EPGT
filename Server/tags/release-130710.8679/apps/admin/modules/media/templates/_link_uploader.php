...
//    window.location.reload(true);
    id = select.val();
    <?php if(!isset ($show)):?>
        $("#media_list").load("<?php echo url_for('media/category_files?rand='.rand()) ?>", {"category_id": id, "popup": 0});
    <?php else:?>
        $("#media_list").load("<?php echo url_for('media/category_files?rand='.rand()) ?>", {"category_id": id, "popup": 1});
    <?php endif;?>
};
