...
<?php if($searchCondition['type']=='list'):?>
                        <div class="daychoice">
...
<?php else:?>                  	
                        <div class="daychoice">
                        	<h2 class="taber"><a href="<?php echo url_for("/vod/index?type=".$searchCondition['type']."&style=tile")?>" class="tiles">平铺</a><a href="<?php echo url_for("/vod/index?type=".$searchCondition['type']."&style=list")?>" class="lists">列表</a></h2>
                            
                            <div class="mvlist">
        					<?php if ($wiki_pager->count() > 0):?>           
                            	<ul class="clr">
                                <?php foreach ($wiki_pager as $wiki): ?>        
                                	<li><a href="<?php echo "/wiki/show?slug=".$wiki->getSlug()?>"><img src="<?php echo thumb_url($wiki->getCover(), 100, 150)?>" alt=""/><?php echo $wiki->getTitle()?></a></li>
                                <?php endforeach;?>    
                                </ul>
