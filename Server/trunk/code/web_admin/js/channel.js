$(function(){
        ...
        var recommend    = $(".sf_admin_list_td_recommend");
        ...
        recommend.click(function(){
        	if($("#recommend").html() == null )
        	{
        		var id  = $.trim($(this).parent().find('.sf_admin_list_td_id').text());
        		$(this).attr('id','recommend');
        		ajax_recommend(id);
        	}
        });
...
function ajax_recommend(id)
{
	
	$.ajax({
		url:            "channel/ajax_program_recommend?id=" + id,
		dataType:       "json",
		success:function(data)
		{
		//un_publish="/images/delete.png";
		...
		if(data.code == 1)
		{
			if(data.msg == 0)
			{
				$("#recommend").html('<img src="/images/delete.png" title="UnChecked" alt="Unhecked">');
				//$(".sf_admin_list_td_publish").html('<img src="'+un_publish+'" title="UnChecked" alt="Unhecked">');
			}
			else
			{
				$("#recommend").html('<img src="/images/accept.png" title="Checked" alt="Checked">');
				//$(".sf_admin_list_td_publish").html('<img src="'+publish+'" title="Checked" alt="Checked">');
			}
			$("#recommend").attr('id', '');
			noticeShow(data.content);
