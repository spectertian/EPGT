...
//      ), array());
	  $this->widgetSchema['parent_id'] = new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('TvStation'), 'add_empty' => '添加一级电视台'));
	  $this->widgetSchema['code'] = new sfWidgetFormInputText(array('label'=>'代号','default'=>md5(time())));
...
//      $this->validatorSchema['code'] = new sfValidatorString(array('required' => true),array('required'=>'请填写代号','max_length'=>'不超过32字符'));
      $this->validatorSchema['province'] = new sfValidatorString(array('max_length' => 40,'required' => true),array('required'=>'频道所属省不为空','max_length' => '最长40个字符',));
