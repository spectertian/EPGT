...
/**
 * Base class of TransferStatistics document.
 */
abstract class BaseTransferStatistics extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('TransferStatistics');
    }
    ...
    {
        return $this->getMondongo()->getRepository('TransferStatistics');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['userid'])) {
            $this->data['fields']['userid'] = (string) $data['userid'];
        }
        if (isset($data['tochannel_code'])) {
            $this->data['fields']['tochannel_code'] = (string) $data['tochannel_code'];
        }
    ...
    public function fieldsToMongo($fields)
    {
        if (isset($fields['userid'])) {
            $fields['userid'] = (string) $fields['userid'];
        }
        if (isset($fields['tochannel_code'])) {
            $fields['tochannel_code'] = (string) $fields['tochannel_code'];
        }
    ...
    {
        if (!array_key_exists('userid', $this->fieldsModified)) {
    ...
    /**
     * Set the "tochannel_code" field.
     *
     * @param mixed $value The value.
     *
     * @return void
     */
    public function setTochannelCode($value)
    {
        if (!array_key_exists('tochannel_code', $this->fieldsModified)) {
            $this->fieldsModified['tochannel_code'] = $this->data['fields']['tochannel_code'];
        } elseif ($value === $this->fieldsModified['tochannel_code']) {
            unset($this->fieldsModified['tochannel_code']);
        }

        $this->data['fields']['tochannel_code'] = $value;
    }

    /**
     * Returns the "tochannel_code" field.
     *
     * @return mixed The tochannel_code field.
     */
    public function getTochannelCode()
    {
        return $this->data['fields']['tochannel_code'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['tochannel_code'])) {
            $this->setTochannelCode($array['tochannel_code']);
        }
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['userid']) {
            $array['userid'] = $this->data['fields']['userid'];
        }
        if (null !== $this->data['fields']['tochannel_code']) {
            $array['tochannel_code'] = $this->data['fields']['tochannel_code'];
        }
