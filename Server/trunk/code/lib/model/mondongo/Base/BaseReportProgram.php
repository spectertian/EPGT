...
/**
 * Base class of ReportProgram document.
 */
abstract class BaseReportProgram extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ReportProgram');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ReportProgram');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['channel_name'])) {
            $this->data['fields']['channel_name'] = (string) $data['channel_name'];
        }
        if (isset($data['name'])) {
        ...
        if (isset($data['tag'])) {
            $this->data['fields']['tag'] = (string) $data['tag'];
        }
        if (isset($data['num'])) {
    ...
    public function fieldsToMongo($fields)
    {
        ...
        if (isset($fields['channel_name'])) {
            $fields['channel_name'] = (string) $fields['channel_name'];
        }
    ...
    {
        if (!array_key_exists('channel_name', $this->fieldsModified)) {
            $this->fieldsModified['channel_name'] = $this->data['fields']['channel_name'];
        } elseif ($value === $this->fieldsModified['channel_name']) {
            unset($this->fieldsModified['channel_name']);
        }

        $this->data['fields']['channel_name'] = $value;
    }

    /**
     * Returns the "channel_name" field.
     *
     * @return mixed The channel_name field.
     */
    public function getChannelName()
    {
        return $this->data['fields']['channel_name'];
    }
    ...
    public function fromArray($array)
    {
        ...
        if (isset($array['channel_name'])) {
            $this->setChannelName($array['channel_name']);
        }
        if (isset($array['name'])) {
    ...
    public function toArray($withEmbeddeds = true)
    {
        ...
        if (null !== $this->data['fields']['channel_name']) {
            $array['channel_name'] = $this->data['fields']['channel_name'];
        }
