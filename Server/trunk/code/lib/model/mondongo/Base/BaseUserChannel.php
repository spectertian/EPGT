...
/**
 * Base class of UserChannel document.
 */
abstract class BaseUserChannel extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('UserChannel');
    }
    ...
    {
        return $this->getMondongo()->getRepository('UserChannel');
    }
