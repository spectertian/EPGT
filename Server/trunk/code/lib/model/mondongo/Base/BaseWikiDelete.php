...
/**
 * Base class of WikiDelete document.
 */
abstract class BaseWikiDelete extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('WikiDelete');
    }
    ...
    {
        return $this->getMondongo()->getRepository('WikiDelete');
    }
    ...
    public function setDocumentData($data)
    {
        ...
        if (isset($data['admin'])) {
            $this->data['fields']['admin'] = (int) $data['admin'];
        }
