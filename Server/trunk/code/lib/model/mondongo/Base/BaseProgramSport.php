...
/**
 * Base class of ProgramSport document.
 */
abstract class BaseProgramSport extends \Mondongo\Document\Document implements \ArrayAccess
{
    ...
    {
        return \Mondongo\Container::getForDocumentClass('ProgramSport');
    }
    ...
    {
        return $this->getMondongo()->getRepository('ProgramSport');
    }
