...
<body>
<div id="content"> 
    <p class="heading1">Xunsearch Test</p><br>
    <p class="intro">支持下列操作。</p>
    <form target="_blank" action='/test/xunsearch' method="POST">
    <table cellspacing="0" cellpadding="4" frame="box" bordercolor="#dcdcdc" rules="none" style="border-collapse: collapse;">
        <tr>
            <td class="frmText" style="color: #000000; font-weight: normal;">xmlString:</td>
            <td><input class="frmInput" type="text" size="50" name="keyword"></td>
        </tr>
        <tr>
            <td></td>
