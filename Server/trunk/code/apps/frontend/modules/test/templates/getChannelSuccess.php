...
<BODY>
    <DIV id="content"> 
      ...
      <SPAN>
          ...
          <P class="intro"></P> 
      <H3>GetChannel</H3>
      <FORM target="_blank" action='/test/getChannel' method="POST">
					<TABLE cellspacing="0" cellpadding="4" frame="box" bordercolor="#dcdcdc" rules="none" style="border-collapse: collapse;">
                        ...
                        <TR>
                            <TD class="frmText" style="color: #000000; font-weight: normal;">code:</TD>
                            <TD>
                              <INPUT name="code" type="text" id="code" value="" size="50" />
                            </TD>
                        </TR>                        
                        <TR>
                          <TD>name:</TD>
                          <TD align="right"><INPUT name="name" type="text" id="name" value="" size="50" /></TD>
                        </TR>
                        <TR>
                          <TD></TD>
