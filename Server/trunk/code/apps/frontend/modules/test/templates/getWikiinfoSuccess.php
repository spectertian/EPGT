...
<body>
    <div id="content"> 
      ...
      <span>
          ...
          <p class="intro"></p> 
      <h3>GetWikiinfo</h3>
      <form target="_blank" action='/test/getWikiinfo' method="POST">
					<table cellspacing="0" cellpadding="4" frame="box" bordercolor="#dcdcdc" rules="none" style="border-collapse: collapse;">
                        ...
                        <tr>
                            <td class="frmText" style="color: #000000; font-weight: normal;">wiki_id:</td>
                            <td><!--<input class="frmInput" type="text" size="50" name="xmlString">-->
                              <input name="id" type="text" id="id" value="" size="50" />
                            </td>
                        </tr>                        
                        <tr>
                          <td>tvsouid:</td>
                          <td align="right"><input name="tvsouid" type="text" id="tvsouid" value="" size="50" /></td>
                        </tr>
                        <tr>
                          <td>title:</td>
                          <td align="right"><input name="title" type="text" id="title" value="" size="50" /></td>
                        </tr>
                        <tr>
                          <td>slug:</td>
                          <td align="right"><input name="slug" type="text" id="slug" value="" size="50" /></td>
                        </tr>
                        <tr>
                          <td></td>
