			...
			<ul id="main-nav"> 				
				...
				<li> 
					...
					<ul>
						<li><a <?php if( in_array("tv_station",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('@tv_station')?>">电视台</a></li>
              			...
              			<li><a <?php if( in_array("spservice",$action) ):?>class="current" <?php endif;?> href="<?php echo url_for('spservice/index')?>">运营商管理</a></li>
					</ul>
				</li>				
				<li> 
				...
				<li> 
					...
					<ul>
			              ...
			              <li><a <?php if( in_array("wiki_recommend",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('@wiki_recommend')?>">点播维基</a></li>
			              <li><a <?php if( in_array("wiki_liverecommend",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('@wiki_liverecommend')?>">直播维基</a></li>
				...
				<li> 
					...
					<ul>
						<li><a <?php if( in_array("video_crawler",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('video_crawler/index')?>">百度视频抓取</a></li>
						 <li><a <?php if( in_array("videos_zhui", $action)) :?>class="current" <?php endif;?> href="<?php echo url_for('videos_zhui/index')?>">追剧</a></li>
				...
				<li> 
					...
					<ul>
						...
						<li><a <?php if( in_array("tvsoumatch_wiki",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('tvsoumatch_wiki/index')?>">tvsou匹配wiki</a></li>
						<li><a <?php if( in_array("doubanwiki",$action) ):?>class="current" <?php endif;?>  href="<?php echo url_for('doubanwiki/index')?>">豆瓣匹配维基</a></li>
					</ul>
				</li>	
			</ul> 			
        </div>
