...
<?php include_partial("wiki/screenshots"); ?>
    <div id="content">
        ...
        <header>
          ...
          <nav class="utility">
          <li class="add"><a href="<?php echo url_for("channel_recommend/index")?>">推荐列表</a></li>
          </nav>
        </header>
            <?php include_partial('global/flashes') ?>
            <div class="table_nav">
				
				<form action="<?php echo url_for("channel_recommend/edit");?>" id="addForm" name="addForm" method="post" >
				<div class="widget-body">
				  <ul class="wiki-meta">
                     <li><label>所属频道：</label><?php include_partial('searcha',array( 'topTvStations'=>$parentTvStations,'channels'=>$channels,'channel_id'=>$channel_id,'tvStation_id'=>$tvStation_id, 'tongbu_channel_code'=>$tongbu_channel_code ));?></li>
					 ...
					 <li><input type="hidden" name="id" id="id" value="<?php echo $recommend->getId();?>"><input type="hidden" name="channel_id" id="channel_id" value="<?php echo $channel_id;?>"><input type="submit" value="提交"></li>
				  </ul>
				</div>
				</form>
            </div>
