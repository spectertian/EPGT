...
$(document).ready(function(){
    $("#program_channel_id").change(function(){
        ...
        var GoUrl="<?php echo url_for('channel_recommend/index') ?>?channel_id="+channel_id;
...
<form action="<?php echo url_for('channel_recommend/index') ?>" method="post">
...
查询:电视台:
    ...
    <select name="program_search[channel_id]" id="program_channel_id">
        ...
        <?php endforeach; ?>
    </select><input type="hidden" name="channel_id" id="channel_id" value="<?php echo $channel_id?>"/>
    标题：
