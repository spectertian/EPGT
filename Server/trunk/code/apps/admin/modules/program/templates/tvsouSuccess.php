        ...
        <div class="content_inner">
            ...
            <header class="toolbar">
              ...
              <nav class="utility">
            	...
            	<li class="app-add" style='padding-right:10px'><a href="<?php echo url_for('program/SetEndTime?channel_code='.$channel_code.'&date='.$date)?>">重新生成结束时间</a></li>
    ...
    <tr edit="0">
      ...
      <td class="sf_admin_text sf_admin_list_td_channel noEdit channel"  style="text-align: center;display:none"  >
        ...
        <td class="sf_admin_text sf_admin_list_td_actions noEdit actions edit" rel="<?php echo $program['id'];?>" style="text-align: center;">
          <?php if($program['wiki_id']):?>
	          <a target="_blank" href="<?php echo url_for("wiki/edit?id=".$program['wiki_id'])?>"><font color="<?php echo $program['color']?>"><img src='/images/calendar.png' title='查看维基' alt='查看维基'></font></a>
	          <a href="<?php echo url_for("/program/DelWikiId?id=".$program['id'])?>"><img src="/images/delete.png" title="删除维基" alt="删除维基"></a> <?php endif;?>
	          <a href="#" onclick="del('<?php echo $program['id']?>')"  ><font color="<?php echo $program['color']?>"><img src="/images/cancel.png" title="删除" alt="删除"></font></a>
       	</td>
    </tr>
  <?php endforeach; ?>
<?php endif ?> 
