...
$(function(){
	...
	$('.pre_').click(function(){
		location.href='/yesterday_program?date=<?php echo $pre; ?>';
	});
	$('.next_').click(function(){
		location.href='/yesterday_program?date=<?php echo $next; ?>';
	});
	$('.today').click(function(){
		location.href='/yesterday_program?date=<?php echo date('Y-m-d',time()); ?>';
	});
})
</script>
<div id="content">
    ...
    <table cellspacing="0" id='day'>
      ...
      <tr style="display: table-row;vertical-align: inherit;border-color: inherit;">
          ...
          <td style="text-align:center;width:auto;border: 1px solid #ddd;vertical-align: top;">
              <a href='/yesterday_program/list?date=<?php echo $v[2]; ?>' style='display:block; width:100%; height:100%;'>
