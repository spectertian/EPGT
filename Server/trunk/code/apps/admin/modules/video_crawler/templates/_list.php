...
?>
	<tr edit="0">
		...
		<td class="sf_admin_text sf_admin_list_td_actions noEdit actions edit" rel="<?php echo $vc->getId();?>" style="text-align: center;">
			<a href="#" onclick="changeTR($(this),'newProgram',false);return false;" >编辑</a> | <a href="#" onclick="if(confirm('确定删除吗？')){location.href='video_crawler/Delete/id/<?php echo $vc->getId();?>'; }"  >删除</a>
		</td>
