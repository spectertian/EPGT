      ...
      <div class="content_inner">
        ...
        <header>
          ...
          <nav class="utility">
          	...
          	<li class="delete"><a href="#" onclick="javascript:submitforms('batchDelete')">取消wiki关联</a></li>
            </nav>
        </header>
        ...
        名称：<input type='text' id='title_' name='title' value='<?php echo $title ?>'><button id='zouzhe' style='width:40px'>查询</button>
			...
			<form action="/doubanwiki/batchDelete" id='doubanwikiForm'  method="post">
            <div class="paginator">
