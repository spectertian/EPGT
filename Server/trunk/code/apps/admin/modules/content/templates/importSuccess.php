	...
	if(action == 'save'){
		first_A.text(' 保存 ').attr({'href':'#'}).unbind('click').bind('click',function(){
                        ...
                        */                      
                        ...
                        //提交至服务端处理                        
                        $.post('<?php echo url_for('content/Save') ?>',{"wiki_id":program['wiki_id'],'id':program['id']}, function(data,textStatus){
    ...
    admin_form.submit();
      ...
      <div id="content">
        ...
        <div class="content_inner">            
            ...
            <?php $path="&searchwiki=".$wikistatus."&line=".$line."&check=".$check."&error=".$error;?>
            <div class="table_nav">
            <form action='/content/import' method='get'>

              WIKI:
              <select name='searchwiki'>
                <option value='-1' <?php if ($wikistatus==-1) echo 'selected'; ?>>请选择</option>
            ...
            <table cellspacing="0" id="admin_list" class="adminlist">
              ...
              <?php if(isset ($imports)):?>
                ...
                <tr edit="0">
                  ...
                  <td class="noEdit"><?php echo $types[$import->getFromType()];?>
                  <?php if($import->getStateCheck()==1):?><br/><font style="color:#0000ff">已校对</font><?php endif;?>
                  <?php if($import->getStateError()==1):?><br/><font style="color:#ff0000">有错误</font><?php endif;?>
                  </td>
