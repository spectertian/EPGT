...
<header class="toolbar">
  ...
  <nav class="utility"><!--
    ...
    -->
<!--    <li class="app-add"><a class="toolbar" href="<?php //echo url_for("program_sport/epgUpdate") ?>" title="epg更新">epg更新</a></li>-->
<!--    <li class="app-add"><a class="toolbar" href="<?php //echo url_for("program_sport/channelUpdate") ?>" title="查看所有更新">tvsou更新</a></li>-->
<!--    <li class="app-add"><a class="toolbar" href="<?php //echo url_for("program_sport/channelGet") ?>" title="待抓取频道">待抓取频道</a></li>-->
