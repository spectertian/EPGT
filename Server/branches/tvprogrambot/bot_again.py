...
from TvProgramBot.site.tvsou import SiteTvsou
from TvProgramBot.site.tvsou_api_again import SiteTvsouApi
...
def main():
    ...
    db = getDb()
    channel_list = db.query('SELECT * FROM channel where autosyn=1 and tvsou_get=1 ORDER BY id limit 30').fetchall()
